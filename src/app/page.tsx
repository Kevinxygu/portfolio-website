...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-palette-dark-green text-white">
      {/* Navigation Bar */}
      <Navbar isCompact={isCompact} onToggleCompact={() => setIsCompact(!isCompact)} />
            ...
            <div className="w-full max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex flex-col items-start">
                  ...
                  <h1 className="text-5xl md:text-3xl lg:text-5xl font-bold mb-6 text-palette-medium-green">
                    I&apos;m Kevin
                  </h1>
